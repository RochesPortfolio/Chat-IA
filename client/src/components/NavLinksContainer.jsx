  ...
  return (
    <div className="navLinks" style={{ position: "absolute", bottom: "10px" }}>
      ...
      <NavLinks
        ...
        link="https://meetup-dev.s3.us-east-2.amazonaws.com/static-files/Prompts.pdf"
      />
      <NavLinks
        svg={
          <svg
        ...
        text="Glosario ISO 27001"
        link="https://meetup-dev.s3.us-east-2.amazonaws.com/static-files/Glosario+ISO+27001.pdf"
      />
